...
// Settings row for the display currency. Tapping it opens the currency form sheet (app/currency.tsx)
// listing the supported currencies; choosing one persists it (and re-converts every price in the
// app). Mirrors the other settings rows so it sits naturally inside a SettingsSection.
